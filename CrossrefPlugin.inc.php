...
class CrossrefPlugin extends GenericPlugin implements IDoiRegistrationAgency
{
	...
	{
        // TODO: #doi For all export methods check..
        //  - [ ] if all submissions valid for export? Currently submissions are checked to see if published. Should this continue?
        //  - [ ] If there are any XML-related errors, should null be sent along with the xml prop?
    ...
    private function _getExportPlugin()
    {
        if (empty($this->_exportPlugin)) {
            ...
            // TODO: #doi See if necessary with new queue processing
